...
const ISSUE_FILTER_DESCRIPTION =
  "IssueFilter payload. Examples: label { labels: { id: { in: ['label-id'] } } }; project { project: { id: { eq: 'project-id' } } }; assignee { assignee: { id: { eq: 'user-id' } } }; state { state: { id: { eq: 'state-id' } } }; priority { priority: { eq: 1 } }; due window { dueDate: { gte: '2026-06-09', lte: '2026-06-16' } }; combine with and/or arrays.";
...
export function registerViewActions(rl: RunlinePluginAPI) {
    ...
    rl.registerAction(name, {
      ...
      inputSchema: t.Object({
        ...
        ...(includeSubTeamsDescription
          ? {
              includeSubTeams: t.Optional(
                t.Boolean({ description: includeSubTeamsDescription }),
              ),
            }
          : {}),
      }),
      async execute(input, ctx) {
        ...
        const includeSubTeamsSet =
          includeSubTeamsDescription !== undefined &&
        ...
        const conn = ((data.customView as Record<string, unknown>)?.[
          connectionField
  ...
  listAction(
    "view.list",
    "List custom views accessible to the user, including personal and shared workspace views. Linear excludes views scoped to a specific project or initiative from this root query.",
    "customViews",
    "CustomViewFilter",
    CUSTOM_VIEW_FIELDS,
  );
  getAction(
    "view.get",
    "Get a custom view by ID or slug.",
    "customView",
    CUSTOM_VIEW_FIELDS,
  );
  rl.registerAction("view.create", {
    ...
    inputSchema: t.Object({
      ...
      description: t.Optional(
        t.String({ description: "The description of the custom view" }),
      ),
      icon: t.Optional(
        t.String({ description: "The icon of the custom view" }),
      ),
      color: t.Optional(
        t.String({ description: "The color of the custom view icon (hex)" }),
      ),
      shared: t.Optional(
        t.Boolean({
          description:
            "false creates a personal view; true shares the view with the workspace or scoped container",
        }),
      ),
      filterData: t.Optional(
        t.Object({}, { description: ISSUE_FILTER_DESCRIPTION }),
      ),
      projectFilterData: t.Optional(
        t.Object({}, { description: "ProjectFilter for project views" }),
      ),
      initiativeFilterData: t.Optional(
        t.Object({}, { description: "InitiativeFilter for initiative views" }),
      ),
      feedItemFilterData: t.Optional(
        t.Object(
          {},
          { description: "FeedItemFilter for update/feed item views" },
        ),
      ),
      teamId: t.Optional(t.String({ description: "Scope the view to a team" })),
      projectId: t.Optional(
        t.String({ description: "Scope the view to a project-specific view" }),
      ),
      ...
      ownerId: t.Optional(
        t.String({ description: "Set the user that owns the view" }),
      ),
      id: t.Optional(
        t.String({
          description:
  ...
  rl.registerAction("view.update", {
    ...
    inputSchema: t.Object({
      ...
      name: t.Optional(
        t.String({ description: "The name of the custom view" }),
      ),
      description: t.Optional(
        t.String({ description: "The description of the custom view" }),
      ),
