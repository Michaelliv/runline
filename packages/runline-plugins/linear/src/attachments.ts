...
export function registerAttachmentActions(rl: RunlinePluginAPI) {
  ...
  rl.registerAction("attachment.create", {
    ...
    inputSchema: t.Object({
      issueId: t.String({
        description:
          "The issue to associate the attachment with. UUID or issue identifier (e.g., 'LIN-123')",
      }),
      title: t.String({ description: "The attachment title" }),
      url: t.String({
        description:
          "Attachment location, also used as a unique identifier. Re-creating with the same url updates the existing record",
      }),
      subtitle: t.Optional(
        t.String({ description: "The attachment subtitle" }),
      ),
      iconUrl: t.Optional(
        t.String({
          description:
            "An icon url to display with the attachment (jpg or png, max 1MB, ideally 20x20px)",
        }),
      ),
      commentBody: t.Optional(
        t.String({ description: "Create a linked comment with markdown body" }),
      ),
      groupBySource: t.Optional(
        t.Boolean({
          description:
      ...
      metadata: t.Optional(
        t.Object(
          ...
          {
            description:
              "Attachment metadata object with string and number values (JSONObject)",
          },
        ),
      ),
      id: t.Optional(
  ...
  rl.registerAction("attachment.update", {
    ...
    inputSchema: t.Object({
      ...
      iconUrl: t.Optional(
        t.String({ description: "An icon url to display with the attachment" }),
      ),
      metadata: t.Optional(
        t.Object(
          {},
  ...
  rl.registerAction("attachment.linkURL", {
    ...
    inputSchema: t.Object({
      issueId: t.String({
        description:
          "The issue for which to link the url. UUID or issue identifier (e.g., 'LIN-123')",
      }),
      url: t.String({ description: "The url to link" }),
      title: t.Optional(
        t.String({ description: "The title to use for the attachment" }),
      ),
      id: t.Optional(
        t.String({
