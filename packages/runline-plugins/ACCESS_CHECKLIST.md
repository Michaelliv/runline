...
| `shiftPages` | done | Annotated 10 actions (split out of the former shiftLabs plugin): 4 read (`page.get/list/shares/renderUrl`) and 6 write (`page.create/update/publish/archive/share/revokeShare`). |
...
| `shiftWork` | done | Annotated 23 actions (split out of the former shiftLabs plugin): 13 read (project/issue/issueView get/list/listPage, dependency lists, view execution) and 10 write (project/issue/issueView create/update/delete, comments, dependency add/remove). |
