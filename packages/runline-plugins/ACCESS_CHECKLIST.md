...
| `shiftTranscription` | done | Annotated 6 actions (split out of the former shiftLabs plugin): 4 read (`transcription.job.get/list`, `transcription.artifact.list`, `transcription.transcript`) and 2 write (`transcription.transcribe`, `transcription.job.cancel`). |
