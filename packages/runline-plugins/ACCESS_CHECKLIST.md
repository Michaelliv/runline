...
| `shiftLabs` | done | Annotated 14 actions across modular source files: 6 read (`issue.list/get`, `page.list/get/shares/renderUrl`) and 8 write (`issue.create/comment`, page create/update/publish/archive/share/revokeShare). |
