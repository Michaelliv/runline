...
| **elevenlabs** | 20 | dialogue, audio, history, voices, pronunciationDictionaries, models, speech, transcription, music, sound | `ELEVENLABS_API_KEY` |
...
| **fal** | 8 | image, video, run, queue | `FAL_KEY` |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/gett.svg" width="16" height="16" style="vertical-align: middle"> **gett** | 12 | account, place, driver, ride |  |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/gmail.svg" width="16" height="16" style="vertical-align: middle"> **gmail** | 32 | message, thread, draft, label, profile, alias |  |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/googleCalendar.svg" width="16" height="16" style="vertical-align: middle"> **googleCalendar** | 22 | calendar, event, freeBusy, calendarList, acl, settings |  |
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/googleContacts.svg" width="16" height="16" style="vertical-align: middle"> **googleContacts** | 10 | contact, group |  |
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/googleDocs.svg" width="16" height="16" style="vertical-align: middle"> **googleDocs** | 44 | document |  |
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/googleDrive.svg" width="16" height="16" style="vertical-align: middle"> **googleDrive** | 47 | file, folder, fileFolder, drive, comment, reply, revision, changes, permission, accessProposal, about |  |
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/googleImage.svg" width="16" height="16" style="vertical-align: middle"> **googleImage** | 2 | image | `GOOGLE_API_KEY` |
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/googleSheets.svg" width="16" height="16" style="vertical-align: middle"> **googleSheets** | 23 | spreadsheet, sheet, chart, namedRange, protectedRange, conditionalFormat, dataValidation |  |
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/googleSlides.svg" width="16" height="16" style="vertical-align: middle"> **googleSlides** | 7 | presentation, page |  |
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/googleTasks.svg" width="16" height="16" style="vertical-align: middle"> **googleTasks** | 12 | taskList, task |  |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/linear.svg" width="16" height="16" style="vertical-align: middle"> **linear** | 89 | issue, comment, state, label, project, milestone, projectUpdate, view, cycle, team, initiative, user, attachment, org, webhook | `LINEAR_API_KEY` |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/microsoftCalendar.svg" width="16" height="16" style="vertical-align: middle"> **microsoftCalendar** | 2 | calendar, event |  |
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/microsoftFiles.svg" width="16" height="16" style="vertical-align: middle"> **microsoftFiles** | 5 | files, folder |  |
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/microsoftMail.svg" width="16" height="16" style="vertical-align: middle"> **microsoftMail** | 4 | mail |  |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/node.svg" width="16" height="16" style="vertical-align: middle"> **node** | 38 | fs, path, os, process, crypto, fetch | — |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/openai.svg" width="16" height="16" style="vertical-align: middle"> **openai** | 2 | image | `OPENAI_API_KEY` |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/parallel.svg" width="16" height="16" style="vertical-align: middle"> **parallel** | 1 | search | `PARALLEL_API_KEY` |
...
| **plaud** | 9 | user, recording, transcript, summary, note |  |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/recraft.svg" width="16" height="16" style="vertical-align: middle"> **recraft** | 2 | image | `RECRAFT_API_KEY` |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/replicate.svg" width="16" height="16" style="vertical-align: middle"> **replicate** | 2 | image | `REPLICATE_API_TOKEN` |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/salesforce.svg" width="16" height="16" style="vertical-align: middle"> **salesforce** | 63 | connection, auth, limits, metadata, soql, account, contact, lead, opportunity, case, task, user, sobject |  |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/shiftAtlas.svg" width="16" height="16" style="vertical-align: middle"> **shiftAtlas** | 35 | summary, graph, stage, actor, line, journey, labels, change, task, assignment, relation, binding, evidence | `SHIFT_LABS_API_KEY` |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/shiftObjects.svg" width="16" height="16" style="vertical-align: middle"> **shiftObjects** | 8 | object | `SHIFT_LABS_API_KEY` |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/shiftPages.svg" width="16" height="16" style="vertical-align: middle"> **shiftPages** | 11 | page | `SHIFT_LABS_API_KEY` |
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/shiftTranscription.svg" width="16" height="16" style="vertical-align: middle"> **shiftTranscription** | 7 | transcription | `SHIFT_LABS_API_KEY` |
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/shiftWork.svg" width="16" height="16" style="vertical-align: middle"> **shiftWork** | 29 | project, issue, issueView | `SHIFT_LABS_API_KEY` |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/steel.svg" width="16" height="16" style="vertical-align: middle"> **steel** | 59 | session, scrape, browser, screenshot, pdf, page, file, sessionFile, credential, profile, extension, captcha | `STEEL_API_KEY` |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/together.svg" width="16" height="16" style="vertical-align: middle"> **together** | 2 | image | `TOGETHER_API_KEY` |
...
| **typesafe** | 7 | evaluate, choice, score, noul, raw, model, guide | `TYPESAFE_API_KEY` |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/vercel.svg" width="16" height="16" style="vertical-align: middle"> **vercel** | 14 | whoami, project, deployment, env | `VERCEL_TOKEN` |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/wolt.svg" width="16" height="16" style="vertical-align: middle"> **wolt** | 20 | venue, menu, item, account, address, order |  |
...
| <img src="https://raw.githubusercontent.com/Michaelliv/runline/main/packages/runline-plugins/icons/xai.svg" width="16" height="16" style="vertical-align: middle"> **xai** | 2 | image | `XAI_API_KEY` |
